...
namespace CardsApi.Controllers
{
    ...
    public class CardsController : ControllerBase
    {
        ...
        // GET: api/Cards
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Card>>> GetTodoItems()
        {
        ...
        {
            var result = await _context.Cards.AnyAsync(e => e.CardId == id);

            return CreatedAtAction("Validated", new { Validated = result });
